...
void setup_scr_screen_1(lv_ui *ui)
{
	...
	W25QXX_RTOS(READ, 0x001000 ,password, sizeof(password));
	printf("\nPA:");
	for(int i=0;i<sizeof(password)/sizeof(uint8_t);i++)
	{
		printf("%d ",password[i]);
	}
	memcpy(pd, password, 33);
	...
	lv_textarea_set_placeholder_text(ui->screen_1_ta_1,"Password");
#if LV_USE_KEYBOARD != 0 || LV_USE_ZH_KEYBOARD != 0
    lv_obj_add_event_cb(ui->screen_1_ta_1, ta_event_cb, LV_EVENT_ALL, ui->g_kb_top_layer);
#endif
    lv_obj_set_pos(ui->screen_1_ta_1, 35, 73);
    lv_obj_set_size(ui->screen_1_ta_1, 169, 36);
    ...
    lv_obj_set_style_text_align(ui->screen_1_ta_1, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->screen_1_ta_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_1_ta_1, lv_color_hex(0x83827a), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_border_color(ui->screen_1_ta_1, lv_color_hex(0x4d4d4d), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_pad_bottom(ui->screen_1_ta_1, 4, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->screen_1_ta_1, 4, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_1_ta_1, 6, LV_PART_MAIN|LV_STATE_DEFAULT);
