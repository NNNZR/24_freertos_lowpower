...
void home_digital_clock_1_timer(lv_timer_t *timer)
{
    ...
    {
        lv_dclock_set_text_fmt(guider_ui.home_digital_clock_1, "%d:%02d %s", home_digital_clock_1_hour_value, home_digital_clock_1_min_value, home_digital_clock_1_meridiem);
    }
}
